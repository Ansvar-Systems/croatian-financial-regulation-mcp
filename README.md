...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fcroatian-financial-regulation-mcp.svg)](https://www.npmjs.com/package/@ansvar/croatian-financial-regulation-mcp)
...
**Endpoint:** `https://mcp.ansvar.eu/croatian-financial-regulation/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add croatian-financial-regulation-mcp --transport http https://mcp.ansvar.eu/croatian-financial-regulation/mcp` |
...
```json
{
  "mcpServers": {
    "croatian-financial-regulation-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/croatian-financial-regulation/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/croatian-financial-regulation-mcp
```
...
```json
{
  "mcpServers": {
    "croatian-financial-regulation-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/croatian-financial-regulation-mcp"]
    }
  }
}
```
