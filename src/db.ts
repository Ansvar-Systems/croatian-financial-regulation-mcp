/**
 * SQLite database access layer for the Croatian HANFA/HNB MCP server.
 *
 * Schema:
 *   - sourcebooks        — HANFA and HNB sourcebook directories
 *   - provisions         — individual pravilnici, smjernice, and HNB odluke
 *   - enforcement_actions — HANFA enforcement decisions and sanctions
 *
