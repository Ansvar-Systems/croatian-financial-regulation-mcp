...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across Croatian HANFA and HNB regulatory provisions — pravilnici, smjernice, and odluke.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query in Croatian or English" },
        sourcebook: { type: "string", description: "Filter by sourcebook ID (e.g., HANFA_PRAVILNICI, HNB_ODLUKE). Optional." },
        status: {
          type: "string",
  ...
  },
  {
    ...
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Sourcebook identifier (e.g., HANFA_PRAVILNICI, HANFA_SMJERNICE, HNB_ODLUKE)" },
        reference: { type: "string", description: "Provision reference (e.g., 'Pravilnik o upravljanju rizicima')" },
      },
  ...
  },
  {
    ...
    description: "List all HANFA and HNB sourcebook collections with names and descriptions.",
    inputSchema: { type: "object" as const, properties: {}, required: [] },
  },
  {
    name: "hr_fin_search_enforcement",
    description:
      "Search HANFA enforcement actions — fines, bans, licence revocations, and warnings.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Check whether a specific HANFA or HNB provision reference is currently in force.",
    inputSchema: {
      type: "object" as const,
      properties: {
      ...
      switch (name) {
        ...
        case "hr_fin_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "Croatian HANFA and HNB financial regulation MCP server. Provides access to HANFA pravilnici, smjernice, HNB decisions, and enforcement actions.",
